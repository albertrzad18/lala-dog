            ...
            <div className="text-lg space-y-4">
              ...
              <ol className="space-y-3">
                <li className="text-center">
                  ...
                  <strong>Krótki spacer przed wizytą</strong> – przed wejściem
                  do salonu zadbaj o to, by psiak mógł spokojnie załatwić
                  potrzeby fizjologiczne. Trochę ruchu pomoże mu się też
                  zrelaksować.
                </li>
                <li className="text-center">
                  <span className="text-2xl font-bold">2. </span>
                  <strong>Nie podawaj posiłku tuż przed wizytą</strong> – pełny
                  brzuszek i stres to niezbyt dobre połączenie – najlepiej zjeść
                ...
                <li className="text-center">
                  ...
                  – zwłaszcza w deszczowy dzień – w końcu i tak czeka go
                  porządna, profesjonalna kąpiel!
                </li>
                <li className="text-center">
                  ...
                  – szczególnie jeśli piesek ma alergie, przyjmuje leki lub ma
                  inne potrzeby – warto o tym wspomnieć.
                </li>
                <li className="text-center">
                ...
                <li className="text-center">
                  ...
                  jeśli Twój pies ma np. wrażliwą skórę, lęk separacyjny albo
                  nie lubi suszarki – daj nam znać! Podejdziemy do niego z
                  odpowiednim wyczuciem.
                </li>
                <li className="text-center">
                  <span className="text-2xl font-bold">7. </span>
                  <strong>Zadbaj o spokojne pożegnanie</strong> – Twój spokój =
                  spokój psa. Uśmiechnij się, pomachaj łapką i zostaw resztę
                  nam.
                </li>
              </ol>
            </div>
