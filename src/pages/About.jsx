...
const AboutPage = () => {
  return (
    <>
      <Navbar />
      <FadeInOut>
        <div className="pt-12 md:pt-52 flex flex-col items-center justify-end gap-24 relative text-white ">
          <div className="flex flex-row justify-center flex-wrap w-screen h-[550px] md:h-[370px]">
            <div className="w-full md:w-2/3 lg:w-1/2 h-full rounded-xl p-8 space-y-6 overflow-auto">
              ...
              <p className="text-center text-white text-xl rowdies-regular">
        ...
        <div className="flex flex-row justify-center items-center flex-wrap w-screen bg-purple-400 h-[450px] md:h-[360px]">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center flex-wrap w-screen bg-purple-800 h-[810px] md:h-[460px]">
            <div className="w-full md:w-2/3 lg:w-1/2 h-full rounded-xl p-8 space-y-6 overflow-auto">
              <p className="text-center text-white rowdies-regular text-xl">
