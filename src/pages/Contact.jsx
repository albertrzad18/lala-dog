  ...
  return (
    <>
      ...
      <FadeInOut>
        ...
        />{" "}
        <div className="pt-20 md:pt-44 px-32 flex flex-col md:flex-row items-center justify-center gap-16 font-mono font-semibold">
          <div className="md:w-full h-full  bg-purple-300 rounded-3xl p-8 space-y-6 shadow-xl shadow-[#7e54f0] text-white z-20">
