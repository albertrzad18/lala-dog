...
const ContactPage = () => {
  return (
    <>
      <Navbar />
      <FadeInOut>
        <div className="pt-38 px-32 flex flex-row items-center justify-center gap-16">
          <div className="w-1/2 h-full mx-auto bg-white rounded-xl shadow-lg p-8 space-y-6 border-2 border-green-500">
