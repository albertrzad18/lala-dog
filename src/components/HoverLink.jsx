const HoverLink = ({ text, link }) => {
  return (
    <>
      <button className="btn relative inline-flex items-center justify-start overflow-hidden font-medium font-mono transition-all bg-white rounded-3xl  group py-1.5 px-2.5 border-2 border-black mb-8">
