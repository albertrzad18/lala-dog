...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="fixed top-0 w-full h-19 bg-[#D3D324] z-50 shadow-md">
        <div className="max-w-screen-xl mx-auto flex items-center justify-center md:justify-between py-4 px-4 md:px-6">
          <button
            className="md:hidden"
          ...
          <div className="absolute top-2 left-1/2 transform -translate-x-1/2 hidden md:block">
            <img
              src="logo.jpg"
              className="w-24 md:w-44 rounded-full border-8 border-[#D3D324]"
              alt="Logo"
            />
          </div>
        ...
        {isOpen && (
          <div className="md:hidden bg-[#D3D324] px-4 pb-4 space-y-3 text-lg shadow-md">
            <HoverLink text="O mnie" link="/aboutMe" />
            <HoverLink text="Oferta i cennik" link="/offer" />
            <HoverLink text="Kontakt" link="/contact" />
            <HoverLink text="Galeria" link="/gallery" />
